      ...
      >
        <Grid item xs={12} md={6} component={motion.div} variants={itemVariants}>
            ...
            <Typography variant="body1" sx={{ color: 'text.secondary', fontSize: { xs: '1rem', md: '1.1rem' }, lineHeight: 1.7, mt: 2, mb: { xs: 2, md: 0}, paddingLeft: { xs: 0, md: 4 }, maxWidth: '600px', mx: { xs: 'auto', md: 0 } }}>
                Atualmente, atuo no <strong style={{ color: theme.palette.accent.main }}>Núcleo de Epistemologia Experimental e Cultural (NEC)</strong> da UFPE através da pesquisa científica sobre estruturas cognitivas, principalmente a autoconsciência e também na <strong style={{ color: theme.palette.accent.main }}>clínica BioReligare</strong>, oferecendo Terapia Cognitiva. Além disso, realizo análises de dados, testagens psicológicas e avaliações psicométricas.
            </Typography>
