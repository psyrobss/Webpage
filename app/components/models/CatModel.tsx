...
type CatModelProps = React.ComponentPropsWithoutRef<'group'>;
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Root_Scene">
        ...
        <group name="Cat_Blob" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <skinnedMesh castShadow receiveShadow name="Cat_Blob_1" geometry={nodes.Cat_Blob_1.geometry} material={materials.PaletteMaterial001} skeleton={nodes.Cat_Blob_1.skeleton} />
          <skinnedMesh castShadow receiveShadow name="Cat_Blob_2" geometry={nodes.Cat_Blob_2.geometry} material={materials.PaletteMaterial001} skeleton={nodes.Cat_Blob_2.skeleton} />
          <skinnedMesh castShadow receiveShadow name="Cat_Blob_3" geometry={nodes.Cat_Blob_3.geometry} material={materials.PaletteMaterial001} skeleton={nodes.Cat_Blob_3.skeleton} />
          <skinnedMesh castShadow receiveShadow name="Cat_Blob_4" geometry={nodes.Cat_Blob_4.geometry} material={materials.PaletteMaterial001} skeleton={nodes.Cat_Blob_4.skeleton} />
          <skinnedMesh castShadow receiveShadow name="Cat_Blob_5" geometry={nodes.Cat_Blob_5.geometry} material={materials.PaletteMaterial001} skeleton={nodes.Cat_Blob_5.skeleton} />
        </group>
      </group>
    </group>
  )
